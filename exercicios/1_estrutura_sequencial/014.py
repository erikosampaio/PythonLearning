...
# peixes) e calcule o excesso. Gravar na variável excesso a quantidade
...
peso = float(input("Informe o peso dos peixe: "))

excesso = (peso - 50)
multa = excesso * 4

print(f'''
Peso dos peixes que você pescou: {peso:.2f} Kg
Peso excedido conforme regulamento: {excesso:.2f} Kg
Multa gerada pelo excesso do peso: R$ {multa:.2f}
''')
